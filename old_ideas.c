...
/*   Updated: 2024/12/19 11:30:55 by ekosnick         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// This WAS MEANT IF WE WERE GOING TO DEAL WITH THE TOP AND BOTTOM OF B STACK
// void	pusher(t_list ***sta, t_list **stb)
// {
// 	int		tb;
// 	int		ta;
...
// 	{
// 		if (tb ta)
// 		if (ft_lstlast(**sta) < (min_sta(**sta) + 4))
// 		else
// 			ptoa(**sta, *stb); /*&stb*/
// 	}
// }
